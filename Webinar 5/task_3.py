...
def everything_for_your_cat(cats_data):
    """
    Оптимизирует хранение данных - для каждого владельца при выводе (одна строка)
    данные о всех его животных в одной строке, на новой строке следующий покупатель и все его питомцы и т.д.
    :param cats_data: список кортежей с неоптимизированными данными в формате:
    Кличка котика, Возраст котика, Имя покупателя, Фамилия покупателя
    :return: строка, где на каждой строке указыается один владелец и все его животные:
    Имя_покупателя Фамилия_покупателя: Кличка_котика1, Возраст; ...; Кличка_котикаN, Возраст\n
    """
    owner_dic = {}
    our_str = ""
