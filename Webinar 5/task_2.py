...
def repeats(our_str):
    """
    Преобразует входную строку к виду, где после каждого символа указывается
    сколько раз он уже встретился. Например (Ввод --> Вывод):
    'letter' --> l_1e_1t_1t_2e_2_r_1
    :param our_str: строка для подсчета
    :return: преобразованная строка
    """
    new_str = ""
    for ch in our_str:
        new_str += ch + "_" + str(new_str.count(ch) + 1)
    return new_str
