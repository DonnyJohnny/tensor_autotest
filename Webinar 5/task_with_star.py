...
def to_roman(val):
    """
    Преобразует арабскую запись числа в римскую. Валидно преобразует числа от 1 до 3999
    :param val: арабское число от 1 до 3999
    :return: римская запись числа
    """
    roman_dict = {0: '', 1: 'I', 2: 'II', 3: 'III', 4: 'IV', 5: 'V', 6: 'VI', 7: 'VII', 8: 'VIII', 9: 'IX',
    ...
    for i in range(len(val_str)):
        digit = int(val_str[i]) * 10 ** (len(val_str) - (i + 1))
