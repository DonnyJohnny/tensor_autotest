...
def treatment_sum(our_tuple: tuple):
    ...
    :param our_tuple: кортеж с элементами для суммирования.
    :return: Сумму элементов, если в кортеже два элемента, иначе возвращает соответствующее исключение
    """
    try:
        sm = our_tuple[0] + our_tuple[1]
    except TypeError:
